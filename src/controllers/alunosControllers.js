...
exports.createAluno = async (req, res) => {
  try {
    ...
    console.log('Dados recebidos no backend:', { name, year, classYear }) // Log dos dados recebidos
    ...
    // Salvando o aluno
    await newAluno.save()
    console.log('Aluno criado com sucesso:', newAluno) // Log do aluno criado
    res.status(201).send(newAluno)
  } catch (error) {
    console.log('Erro ao criar aluno:', error.message) // Log do erro
    res.status(400).send({
